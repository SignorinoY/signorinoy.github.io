...
permalink: data-structure-josephus-problem
---

约瑟夫(Joseph)问题的一种描述是:编号为 $1,2,..., n$ 的 $n$ 个人按顺时针方向围坐一圈, 每人持有一个密码(正整数).一开始选任一个正整数作为报数上限值 $m$ , 从第一个人开始按顺时针方向自1开始顺序报数,报到m时停止报数.报m的人出列,将它的密码作为新的m值,再从下个人开始新一轮报数,如此反复,直到剩下最后一人则为获胜者.试设计一个程序求出出列顺序.
<!-- more -->
